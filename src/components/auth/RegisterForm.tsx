  ...
  if (success) {
    return (
      <div className="text-center space-y-4">
        <p className="text-jade">Conta criada com sucesso! Verifique seu email para confirmar.</p>
        <button onClick={onSwitchLogin} className="btn-primary w-full">
          Voltar ao Login
        </button>
      </div>
    );
  ...
  return (
    <form onSubmit={handleRegister} className="space-y-4">
      ...
      <button
        ...
        className="w-full text-sm text-paper/50 hover:text-jade transition-colors"
      >
        Já tenho uma conta
      </button>
    </form>
