  ...
  return (
    <form onSubmit={handleLogin} className="space-y-4">
      ...
      <div className="flex justify-between text-sm mt-4">
        <button type="button" onClick={onSwitchRecover} className="text-paper/50 hover:text-jade transition-colors">Esqueci a senha</button>
        <button type="button" onClick={onSwitchRegister} className="text-jade hover:text-white transition-colors">Criar Conta</button>
      </div>
    </form>
  );
}
