...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    // Generate a green placeholder for any asset that fails to load, so the
    // game still boots while real art is being produced.
  ...
  create() {
    // Only build a walk animation when the player texture actually has frames.
    // (A generated placeholder has a single frame.)
