...
export class Academy extends Scene {
  ...
  create() {
    ...
    // Tilemap (renders a floor when the map JSON + tileset are present)
  ...
  update() {
    ...
    if (vx !== 0 || vy !== 0) {
      ...
      // Throttled position broadcast for autosave
